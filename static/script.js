...
function init() {
  ...
  addRoom("lobby");
  addRoom("Gaming Room");
  addRoom("Programming Room");
  changeRoom("lobby");
  addMessage("lobby", "Rocket", "Hey!", true);
  addMessage("Gaming Room", "Rocket", "Have Fun and Play With Gamers", true);
  addMessage("Programming Room", "Rocket", "Let's Learn Programming With Each Other!", true);
